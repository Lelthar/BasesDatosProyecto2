 ...
 * @author Jeanca
 */
public class VentanaGoleadoresMundial extends javax.swing.JFrame {

    /**
     * Creates new form EquiposConfederacion
     */
    public VentanaGoleadoresMundial() {
        initComponents();
    ...
    private void obtenerEquiposConfederacion() {
        try {
            String[] strSalto = { };
            ResultSet resultSet = Conexion.Conexion.realizarConsulta("select jugador.numero_pasaporte, jugador.NOMBRE,equipo.NOMBRE_PAIS, count(*) as goles from jugador inner join goles_por_partido on(jugador.numero_pasaporte = goles_por_partido.numero_pasaporte_jugador) inner join equipo on(jugador.codigo_equipo = equipo.codigo_equipo) where jugador.codigo_equipo  = goles_por_partido.codigo_equipo group by jugador.numero_pasaporte, jugador.NOMBRE,equipo.NOMBRE_PAIS Order by count(*) desc,jugador.NOMBRE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaGoleadoresMundial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaGoleadoresMundial().setVisible(true);
            }
        });
    }
