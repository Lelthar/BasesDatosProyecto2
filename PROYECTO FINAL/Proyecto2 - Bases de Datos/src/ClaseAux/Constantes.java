...
/**
 * Clase para la administración de constantes en el programa.
 * @author Jeanca
 */
public class Constantes {
    ...
    public static final String PATH_MANUAL = "src/Complementos/manual_de_usuario_campeonato_mundial.pdf";
}
