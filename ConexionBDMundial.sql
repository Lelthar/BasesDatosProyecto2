 ...
 * HAY RELACIONES Y TABLAS QUE DIFIEREN DEL MODELO CONCEPTUAL.
 * EN LAS TABLAS DE EQUIPOS LOCAL/VISITA SE AGREGÓ UNA RELACIÓN AL EQUIPO.
 * SE CREÓ UNA TABLA DE CAPITANES POR LA POSIBLE EXISTENCIA DE MÁS DE UN CAPITÁN POR PARTIDO.
 * EN LA TABLA DE CUERPO TÉCNICO SE CREARON 2 LLAVES FORANEAS A ASISTENTES DE ENTRENADOR, ESTO PORQUE SIEMPRE SON 2 ASISTENTES POR PARTIDO.
 * NO EXISTE PROBLEMA EN NO REGISTRAR UN PENAL EN LA TABLA DE GOLES POR PARTIDO, PORQUE EL GOL SE RELACIONA A UN JUGADOR EN UN DETERMINADO PARTIDO.
 */
...
CREATE TABLE partido (
    ...
    min_extra_primer_tiempo TIME NOT NULL,
    min_extra_segundo_tiempo TIME NOT NULL,
	nombre_sede CHAR(40) NOT NULL,
	nombre_estadio CHAR(40) NOT NULL,
	tiempos_extra CHAR(2) CHECK (tiempos_extra = 'SI' OR
	                             tiempos_extra = 'NO') NOT NULL,
    PRIMARY KEY (numero_partido),
	FOREIGN KEY (nombre_sede, nombre_estadio) REFERENCES sede
)
...
CREATE TABLE capitan_local (							/* CAPITANES_POR_PARTIDO_EQUIPO_LOCAL */
	...
	minuto_inicio_capitan TIME NOT NULL,
	minuto_fin_capitan TIME NOT NULL,
